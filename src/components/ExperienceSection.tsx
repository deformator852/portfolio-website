...
const experiences = [
  {
    ...
    period: "2025 - Present",
    description:
      "Delivering end-to-end automation workflows and intelligent systems using no-code/low-code platforms (n8n, Make.com, Zapier) and Python + Javascript. Built chatbots, lead capturing automation, real-time notification systems, marketing automation, CRM synchronization, automated reporting dashboards, web apps for automation management, WordPress automation, recruitment & candidate processing, and many other projects. Integrated third-party tools and APIs including Airtable, HubSpot, etc.",
    skills: [
      "AI Agents",
      "Slack",
      "Notion",
